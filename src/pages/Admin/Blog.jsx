...
const BlogManager = ({ setIsAdminLoggedIn }) => {
  ...
  const Divider = () => (
    <div className="w-px h-6 bg-slate-700 mx-1 self-center opacity-50" />
  );
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-slate-400 mt-1">
                Create and manage news and articles
              </p>
            </div>
            <button
              onClick={() => {
                ...
                <div
                  ...
                  <div className="relative h-52 bg-slate-800 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className={`${getCategoryColor(blog.category)} text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-md`}>
